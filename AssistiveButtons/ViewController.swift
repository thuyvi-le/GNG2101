...
//  AssistiveButtons
//
//  Created by Gianluca Coletti on 2020-10-25.
//
...
class ViewController: UIViewController, ARSCNViewDelegate {
    ...
    func renderer(_ renderer: SCNSceneRenderer, didAdd node: SCNNode, for anchor: ARAnchor) {
        ...
        guard let imageAnchor = anchor as? ARImageAnchor, let fileUrlString = Bundle.main.path(forResource: "buttonLocated", ofType: "png") else {return}
